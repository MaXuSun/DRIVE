...
class AlignDataset(Dataset):
    """domain adaptation align Dataset"""
...
class ClassDataset(Dataset):
    """Read the data of each domain by category """
...
class DgAlighDataset(Dataset):
    def __init__(self,*datasets,choose_num=2):
